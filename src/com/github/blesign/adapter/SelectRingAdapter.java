...
public class SelectRingAdapter extends BaseAdapter {
	 ...
	 */
	public SelectRingAdapter(Context context, int index) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		/* 设定按钮背景图 */
		mHodler.iv
				.setBackgroundResource(map.get(position) == null ? R.drawable.ring_pressed
						: R.drawable.ring_checked);
